  ...
  return (
    <>
      <div className="shopping-cart">
        ...
        {totalAmount > 0 && <button className="clear-cart-btn" onClick={handleClearCart}>Clear Cart</button>}

      </div>
      <div className="shopping-cart-title">{totalAmount ? <div>The total amount is ${totalAmount} </div> : ''}</div>
    </>
  );
};
